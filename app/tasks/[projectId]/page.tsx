...
export default function KanbanBoard() {
  ...
  // Update task assignment from modal
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    {selectedTask.assignedTo && projectMembers && Array.isArray(projectMembers) ? (
                      <div className="flex items-center">
                        {projectMembers.find(m => m.userId === selectedTask.assignedTo) ? (
                          <>
                            <div className="w-6 h-6 rounded-full bg-blue-600 flex items-center justify-center text-white text-xs font-medium mr-2">
                              {projectMembers.find(m => m.userId === selectedTask.assignedTo)?.name?.charAt(0) || "?"}
                            </div>
                            <span>
                              {projectMembers.find(m => m.userId === selectedTask.assignedTo)?.name || "Unknown"}
                            </span>
                          </>
                        ) : (
                ...
                {/* Member Assignment */}
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-gray-400 mb-2">Assign Member</h4>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    <textarea
                      ...
                      rows={4}
                      className="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-white resize-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <button
                      onClick={async () => {
                        if (selectedTask) {
                      ...
                      className="px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg flex items-center justify-center text-white text-sm font-medium w-full"
                    >
